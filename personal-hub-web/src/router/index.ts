  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'notes', name: 'NoteList', meta: { title: '笔记' }, component: () => import('@/modules/knowledge/note/List.vue') },
        { path: 'notes/new', name: 'NoteCreate', meta: { title: '新建笔记' }, component: () => import('@/modules/knowledge/note/List.vue') },
        { path: 'notes/recycle', name: 'RecycleBin', meta: { title: '回收站' }, component: () => import('@/modules/knowledge/note/RecycleBin.vue') },
        { path: 'notes/:id/edit', name: 'NoteEdit', meta: { title: '编辑笔记' }, component: () => import('@/modules/knowledge/note/List.vue') },
