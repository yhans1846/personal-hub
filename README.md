...
| 模块 | 核心能力 |
|------|----------|
| **📝 笔记** | Markdown · Table/Card · 分类/标签 · 归档/回收站 · 批量 ZIP 导出 · 列表内全屏 Overlay · 三栏分屏（编辑/预览/大纲） |
...
- **一屏铺满列表** — `useMainContentFill` + 矮屏 10/8/6 · Product Table/Card · 统一 ListToolbar（`.toolbar-btn` 次要/危险与主按钮并排）
- **回收站增强** — 删除/归档原因追踪 · 分类标签保留 · 审计可追溯 · 一键清空 · fill 布局
- **数据备份** — 用户级 ZIP + 服务端历史/自动备份；设置「数据管理」Tab
...
- **CRUD 交互规范** — Dialog 替代页面跳转；笔记列表内全屏 Overlay + 三栏分屏除外
- **文件边界** — 文件页只管本页上传（可一键清空）；笔记/日记配图各自资源目录，互不误删
