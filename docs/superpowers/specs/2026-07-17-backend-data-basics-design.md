...
| 枚举 | 模块包 | 码 → 文案 |
|------|--------|-----------|
| `ReadingStatus` | `ph-biz/.../knowledge/enums` | 0 未读 / 1 在读 / 2 读完 |
| `DiaryMood` | `ph-biz/.../knowledge/enums` | 1 很好 / 2 开心 / 3 一般 / 4 不好 / 5 很差 |
| `StudyPlanStatus` | `ph-biz/.../planning/enums` | 0 未开始 / 1 学习中 / 2 已完成 / 3 已暂停 |
| `TodoPriority` | `ph-biz/.../planning/enums` | 1 高 / 2 中 / 3 低 |
